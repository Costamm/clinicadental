...
public class Main {
    public static void main(String[] args) {
        ...
        // Datos de prueba (Usando tus datos de la imagen)
        Domicilio dom1 = new Domicilio(1L, "Av. Siempre Viva", 742, "Springfield", "Buenos Aires");
        Paciente pac1 = new Paciente(101L, "Juan", "Perez", "47034598", "juan@email.com", LocalDate.now(), dom1);
        Odontologo odon1 = new Odontologo(501L, "Julian", "Lopez", "MN-88342");

        // 1. Agregamos a la familia (Esto dispara el primer mensaje)
